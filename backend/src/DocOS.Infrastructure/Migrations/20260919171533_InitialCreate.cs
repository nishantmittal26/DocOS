        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LetterheadMarginTopMm = table.Column<int>(type: "integer", nullable: false),
                    PatientIdPrefix = table.Column<string>(type: "text", nullable: false),
                    LastPatientSequence = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaltComposition = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ClinicId = table.Column<Guid>(type: "uuid", nullable: false),
                    PatientUid = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemperatureF = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicines_SaltComposition",
                table: "Medicines",
                column: "SaltComposition");

            migrationBuilder.CreateIndex(
                name: "IX_Patients_ClinicId_MobileNumber",
                table: "Patients",
                columns: new[] { "ClinicId", "MobileNumber" });

            migrationBuilder.CreateIndex(
                name: "IX_Patients_ClinicId_PatientUid",
                table: "Patients",
                columns: new[] { "ClinicId", "PatientUid" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visits_ClinicId_VisitDate",
                table: "Visits",
                columns: new[] { "ClinicId", "VisitDate" });
